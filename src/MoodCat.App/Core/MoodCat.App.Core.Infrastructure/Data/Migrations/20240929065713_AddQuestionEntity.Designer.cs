...
namespace MoodCat.App.Core.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240929065713_AddQuestionEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoodCat.App.Core.Domain.Notes.NoteAttachment", b =>
                {
                    ...
                    b.ToTable("NotesAttachments", (string)null);
                });
            ...
            modelBuilder.Entity("MoodCat.App.Core.Domain.Notes.NoteEntity", b =>
                {
                    ...
                    b.Property<string>("AllowedNoteSupervisorId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Content", "MoodCat.App.Core.Domain.Notes.NoteEntity.Content#NoteContent", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Title", "MoodCat.App.Core.Domain.Notes.NoteEntity.Title#NoteTitle", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("MoodCat.App.Core.Domain.Questions.QuestionEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("NoteAnswerId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MoodCat.App.Core.Domain.Users.User", b =>
                {
                    ...
                    b.Property<bool>("IsHealthSpecialist")
                        .HasColumnType("bit");

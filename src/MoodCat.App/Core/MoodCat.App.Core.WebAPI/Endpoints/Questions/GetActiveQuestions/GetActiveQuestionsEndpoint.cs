...
namespace MoodCat.App.Core.WebAPI.Endpoints.Questions.GetActiveQuestions;

/// <summary>
/// Pobiera aktywne pytania użytkownika
/// </summary>
public class GetActiveQuestionsEndpoint : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        app.MapGet("/api/questions/active", async (ISender sender, ClaimsPrincipal claimsPrincipal,
                ApplicationDbContext dbContext) =>
            {
                ...
                questions = questions.Where(x => !x.IsAnswered).ToList();
            ...
            .WithName("GetActiveQuestionsEndpoint")
            .WithSummary("Get the active questions for the user.")
            .WithDescription("Get the active questions for the user.")
            .WithTags("Questions");
    }
}